							...
							<table align="center" border="0" width="95%">
								<tbody>
									<tr valign="top">
										<td>
											<h1 align="center">
												<br> <font face="Verdana, Arial, Helvetica, sans-serif">Bon
														de commande</font>
											</h1>
											<br /><br />
											<p>
											...
											<form action="${loginAction}" id="loginForm" method="post" commandName="login">
												<table align="center" border="0" width="95%">
													<tbody>
														<tr valign="top">
															<td width="32%"><font
																face="Verdana, Arial, Helvetica, sans-serif" size="2">Votre
																	nom</font></td>
															<td width="68%"><input name="NOM" size="40"
																type="text" value=" ${client_S.nom }"
														...
														<tr valign="top">
															...
															<td width="68%"><input name="PRENOM" size="40"
																type="text" value=" ${client_S.prenom }"
																disabled="disabled"></td>
														</tr>
														<tr valign="top">
															<td width="32%"><font
															...
															<td width="68%"><input name="ADR_EMAIL" size="40"
																 value=" ${client_S.email }" disabled="disabled"></td>
														</tr>
														<tr valign="top">
															<td width="32%"><font
																face="Verdana, Arial, Helvetica, sans-serif" size="2">Votre
															...
															<td width="68%"><input name="ADRESSE" size="40"
																	value=" ${client_S.adresse.rue }" disabled="disabled"></input></td>
														</tr>
														<tr valign="top">
															<td width="32%"><font
																face="Verdana, Arial, Helvetica, sans-serif" size="2">Ville</font></td>
															<td width="68%"><input name="VILLE" size="40"
																type="text" value=" ${client_S.adresse.ville }" disabled="disabled"></td>
														</tr>
														<tr valign="top">
															<td width="32%"><font
															...
															<td width="68%"><input name="CP" size="40"
																type="text" value=" ${client_S.adresse.codePostal }" disabled="disabled"></td>
														</tr>
														<tr valign="top">
															<td width="32%"><font
																face="Verdana, Arial, Helvetica, sans-serif" size="2">Téléphone</font></td>
															<td width="68%"><input name="TEL" size="40"
																type="text" value=" ${client_S.tel }" disabled="disabled"></td>
														</tr>
													</tbody>
												</table>
												<br /><br />
												...
												<br /><br />
												<p>
													<font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Choisissez
														votre moyen de paiement :</b></font>
												</p>
												<p align="center">
													<select name="MOYEN_PAIEMENT"><option value="1"
															selected="selected">Paypal (Carte VISA ou
															MASTERCARD) - Livraison immédiate</option>
														<option value="2">Moneybookers (cartes bancaires)
															- Livraison immédiate</option>
														<option value="3">Allopass (Carte Bleue) -
															Livraison immédiate</option>
														<option value="4">Chèque - Livraison à la
															réception</option>
														<option value="5">Virement bancaire - Livraison à
															la réception</option>
														<option value="6">Espèces - Livraison à la
															réception</option></select>
												</p>
												<br /><br />
												<p align="center">
