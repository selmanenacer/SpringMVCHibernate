...
<div id="main_container">
  <div class="top_bar">
    ...
    <div class="languages">
      ...
      <a href="#" class="lang"><img src="${img }/en.gif" alt="" border="0" /></a> <a href="#" class="lang"><img src="${img }/de.gif" alt="" border="0" /></a> </div>
  </div>
  <div id="header">
    ...
    <div class="oferte_content">
      ...
      <div class="oferta">
        <div class="oferta_content"> <img src="${img }/laptop.png" width="94" height="92" alt="" border="0" class="oferta_img" />
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li><a href="contact.html" class="nav6">${sessionScope.nom} ${sessionScope.prenom}</a></li>
        <li class="divider"></li>
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="contact_form">
            ...
            <div class="form_row"> <input type="submit" value="Connexion" class="sansLabel" /> </div>
            <p><strong ><h3><font color="red">email ou mot de passe incorrecte veuillez réessayer</font></h3></strong> </p>
              </form>
                </c:when>
                  <c:when test="${resultat == 'succés'}" >
                      <h2>Bienvenue sur notre site ${sessionScope.nom} ${sessionScope.prenom}</h2>  
  ...
  <div class="footer">
    ...
    <div class="center_footer"> Template name. All Rights Reserved 2008<br />
      <a href="http://csscreme.com"><img src="${img }/csscreme.jpg" alt="csscreme" border="0" /></a><br />
